...
/*   Updated: 2023/05/26 19:01:31 by oaboulgh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// int	handle_append(t_tree *root, t_data data, t_env **env, t_fds *fds)
// {
...
// 	data.status = execute_cmd(root->left, data.infile_fd, data.j, env, fds);
// 	if (data.status == 1)
// 		return (1);
// 	data.status = execute_cmd(root->right, data.infile_fd, \
// 		data.outfile_fd, env, fds);
// 	if (data.status == 1)
// 		return (1);
// 	return (0);
// }
